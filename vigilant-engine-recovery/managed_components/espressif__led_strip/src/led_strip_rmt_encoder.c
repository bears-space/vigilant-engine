...
esp_err_t rmt_new_led_strip_encoder(const led_strip_encoder_config_t* config,
    ...
    ESP_GOTO_ON_FALSE(config && ret_encoder, ESP_ERR_INVALID_ARG, err, TAG,
                      "invalid argument");
    ESP_GOTO_ON_FALSE(config->led_model < LED_MODEL_INVALID,
                      ESP_ERR_INVALID_ARG, err, TAG, "invalid led model");
    ...
    uint32_t reset_ticks =
        ...
        2;  // reset code duration defaults to 280us to accommodate WS2812B-V5
    if (config->led_model == LED_MODEL_SK6812) {
            ...
            .bit0 =
                {
                    .level0 = 1,
                    .duration0 =
                        0.3 * config->resolution / 1000000,  // T0H=0.3us
                    .level1 = 0,
                    .duration1 =
                        0.9 * config->resolution / 1000000,  // T0L=0.9us
                },
            .bit1 =
                {
                    .level0 = 1,
                    .duration0 =
                        0.6 * config->resolution / 1000000,  // T1H=0.6us
                    .level1 = 0,
                    .duration1 =
                        0.6 * config->resolution / 1000000,  // T1L=0.6us
                },
            .flags.msb_first =
            ...
            .bit1 =
                {
                    .level0 = 1,
                    .duration0 =
                        0.9 * config->resolution / 1000000,  // T1H=0.9us
                    .level1 = 0,
                    .duration1 =
                        0.3 * config->resolution / 1000000,  // T1L=0.3us
                },
            .flags.msb_first =
        ...
        // different led strip might have its own timing requirements, following
        // parameter is for WS2811
        bytes_encoder_config = (rmt_bytes_encoder_config_t){
            .bit0 =
                {
                    .level0 = 1,
                    .duration0 =
                        0.5 * config->resolution / 1000000.,  // T0H=0.5us
                    .level1 = 0,
                    .duration1 =
                        2.0 * config->resolution / 1000000.,  // T0L=2.0us
                },
            .bit1 =
                {
                    .level0 = 1,
                    .duration0 =
                        1.2 * config->resolution / 1000000.,  // T1H=1.2us
                    .level1 = 0,
                    .duration1 =
                        1.3 * config->resolution / 1000000.,  // T1L=1.3us
                },
            .flags.msb_first = 1};
        reset_ticks = config->resolution / 1000000 * 50 /
                      2;  // divide by 2... signal is sent twice
    } else if (config->led_model == LED_MODEL_WS2816) {
        // different led strip might have its own timing requirements, following
        // parameter is for WS2816
        bytes_encoder_config = (rmt_bytes_encoder_config_t){
            .bit0 =
                {
                    .level0 = 1,
                    ...
                    .level1 = 0,
                    .duration1 =
                        0.95 * config->resolution / 1000000,  // T0L=0.95us
                },
            .bit1 =
                {
                    .level0 = 1,
                    .duration0 =
                        0.75 * config->resolution / 1000000,  // T1H=0.75us
                    .level1 = 0,
                    .duration1 =
                        0.5 * config->resolution / 1000000,  // T1L=0.5us
                },
            .flags.msb_first = 1};
    } else {
        assert(false);
